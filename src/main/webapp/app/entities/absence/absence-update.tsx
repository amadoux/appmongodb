  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appmongodbApp.absence.home.createOrEditLabel" data-cy="AbsenceCreateUpdateHeading">
            <Translate contentKey="appmongodbApp.absence.home.createOrEditLabel">Create or edit a Absence</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appmongodbApp.absence.startDate')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.absence.endDate')}
                id="absence-endDate"
                name="endDate"
                data-cy="endDate"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.absence.numberDayAbsence')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.absence.typeAbsence')}
              ...
              >
                {typeAbsenceValues.map(typeAbsence => (
                  <option value={typeAbsence} key={typeAbsence}>
                    {translate('appmongodbApp.TypeAbsence.' + typeAbsence)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('appmongodbApp.absence.confirmationAbsence')}
              ...
              >
                {confirmationAbsenceValues.map(confirmationAbsence => (
                  <option value={confirmationAbsence} key={confirmationAbsence}>
                    {translate('appmongodbApp.ConfirmationAbsence.' + confirmationAbsence)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('appmongodbApp.absence.congeRestant')}
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('appmongodbApp.absence.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
