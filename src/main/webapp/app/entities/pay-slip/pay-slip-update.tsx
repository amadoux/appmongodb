  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appmongodbApp.paySlip.home.createOrEditLabel" data-cy="PaySlipCreateUpdateHeading">
            <Translate contentKey="appmongodbApp.paySlip.home.createOrEditLabel">Create or edit a PaySlip</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appmongodbApp.paySlip.netSalaryPay')}
              ...
              <ValidatedField
                label={translate('appmongodbApp.paySlip.paySlipDate')}
              ...
              />
              <ValidatedBlobField
                label={translate('appmongodbApp.paySlip.uploadPaySlip')}
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('appmongodbApp.paySlip.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
