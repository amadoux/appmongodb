    ...
    <Row>
      <Col md="8">
        <h2 data-cy="paySlipDetailsHeading">
          <Translate contentKey="appmongodbApp.paySlip.detail.title">PaySlip</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            ...
            <UncontrolledTooltip target="netSalaryPay">
              <Translate contentKey="appmongodbApp.paySlip.help.netSalaryPay" />
            </UncontrolledTooltip>
          </dt>
          ...
          <dt>
            <Translate contentKey="appmongodbApp.paySlip.employee">Employee</Translate>
          </dt>
