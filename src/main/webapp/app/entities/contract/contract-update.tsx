  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appmongodbApp.contract.home.createOrEditLabel" data-cy="ContractCreateUpdateHeading">
            <Translate contentKey="appmongodbApp.contract.home.createOrEditLabel">Create or edit a Contract</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appmongodbApp.contract.contractType')}
              ...
              <UncontrolledTooltip target="contractTypeLabel">
                <Translate contentKey="appmongodbApp.contract.help.contractType" />
              </UncontrolledTooltip>
              <ValidatedField
                label={translate('appmongodbApp.contract.entryDate')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.contract.releaseDate')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.contract.statusContract')}
              ...
              >
                {statusContractValues.map(statusContract => (
                  <option value={statusContract} key={statusContract}>
                    {translate('appmongodbApp.StatusContract.' + statusContract)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedBlobField
                label={translate('appmongodbApp.contract.uploadContract')}
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('appmongodbApp.contract.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
