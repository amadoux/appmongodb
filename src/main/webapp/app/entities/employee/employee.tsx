  ...
  return (
    <div>
      <h2 id="employee-heading" data-cy="EmployeeHeading">
        <Translate contentKey="appmongodbApp.employee.home.title">Employees</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="appmongodbApp.employee.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/employee/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="appmongodbApp.employee.home.createLabel">Create new Employee</Translate>
          </Link>
        </div>
      </h2>
        ...
        {employeeList && employeeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="appmongodbApp.employee.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="appmongodbApp.employee.enterprise">Enterprise</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {employeeList.map((employee, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`appmongodbApp.Pays.${employee.nationality}`} />
                  </td>
                  <td>
                  ...
                  <td>
                    <Translate contentKey={`appmongodbApp.TypeEmployed.${employee.typeEmployed}`} />
                  </td>
                  ...
                  <td>
                    <Translate contentKey={`appmongodbApp.Department.${employee.department}`} />
                  </td>
                  <td>
                    <Translate contentKey={`appmongodbApp.Level.${employee.level}`} />
                  </td>
                  ...
                  <td>
                    <Translate contentKey={`appmongodbApp.ContractType.${employee.contractType}`} />
                  </td>
                  <td>
                    <Translate contentKey={`appmongodbApp.SalaryType.${employee.salaryType}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="appmongodbApp.employee.home.notFound">No Employees found</Translate>
            </div>
          )
        )}
      </div>
