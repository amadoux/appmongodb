  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appmongodbApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="appmongodbApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appmongodbApp.employee.firstName')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.identityCard')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.dateInspiration')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.nationality')}
              ...
              >
                {paysValues.map(pays => (
                  <option value={pays} key={pays}>
                    {translate('appmongodbApp.Pays.' + pays)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedBlobField
                label={translate('appmongodbApp.employee.uploadIdentityCard')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.typeEmployed')}
              ...
              >
                {typeEmployedValues.map(typeEmployed => (
                  <option value={typeEmployed} key={typeEmployed}>
                    {translate('appmongodbApp.TypeEmployed.' + typeEmployed)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('appmongodbApp.employee.cityAgency')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.residenceCity')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.address')}
                id="employee-address"
                name="address"
                data-cy="address"
                type="text"
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.socialSecurityNumber')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.birthDate')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.birthPlace')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.entryDate')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.releaseDate')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.workstation')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.descriptionWorkstation')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.department')}
              ...
              >
                {departmentValues.map(department => (
                  <option value={department} key={department}>
                    {translate('appmongodbApp.Department.' + department)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('appmongodbApp.employee.level')}
                id="employee-level"
                name="level"
                data-cy="level"
                type="select"
              >
                {levelValues.map(level => (
                  <option value={level} key={level}>
                    {translate('appmongodbApp.Level.' + level)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('appmongodbApp.employee.coefficient')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.numberHours')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.averageHourlyCost')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.monthlyGrossAmount')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.commissionAmount')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.employee.contractType')}
              ...
              >
                {contractTypeValues.map(contractType => (
                  <option value={contractType} key={contractType}>
                    {translate('appmongodbApp.ContractType.' + contractType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('appmongodbApp.employee.salaryType')}
              ...
              >
                {salaryTypeValues.map(salaryType => (
                  <option value={salaryType} key={salaryType}>
                    {translate('appmongodbApp.SalaryType.' + salaryType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('appmongodbApp.employee.hireDate')}
              ...
              <ValidatedField
                ...
                name="enterprise"
                data-cy="enterprise"
                label={translate('appmongodbApp.employee.enterprise')}
                type="select"
              >
                <option value="" key="0" />
                {enterprises
              ...
              <ValidatedField
                ...
                label={translate('appmongodbApp.employee.managerEmployee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
