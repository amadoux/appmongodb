    ...
    <Row>
      <Col md="8">
        <h2 data-cy="socialChargesDetailsHeading">
          <Translate contentKey="appmongodbApp.socialCharges.detail.title">SocialCharges</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="appmongodbApp.socialCharges.enterprise">Enterprise</Translate>
          </dt>
