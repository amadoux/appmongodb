  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appmongodbApp.socialCharges.home.createOrEditLabel" data-cy="SocialChargesCreateUpdateHeading">
            <Translate contentKey="appmongodbApp.socialCharges.home.createOrEditLabel">Create or edit a SocialCharges</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appmongodbApp.socialCharges.spentDate')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.socialCharges.spentType')}
              ...
              >
                {sPentTypeValues.map(sPentType => (
                  <option value={sPentType} key={sPentType}>
                    {translate('appmongodbApp.SPentType.' + sPentType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('appmongodbApp.socialCharges.statusCharges')}
              ...
              >
                {statusChargesValues.map(statusCharges => (
                  <option value={statusCharges} key={statusCharges}>
                    {translate('appmongodbApp.StatusCharges.' + statusCharges)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('appmongodbApp.socialCharges.amount')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.socialCharges.commentText')}
              ...
              <ValidatedField
                ...
                label={translate('appmongodbApp.socialCharges.responsableDepense')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="enterprise"
                data-cy="enterprise"
                label={translate('appmongodbApp.socialCharges.enterprise')}
                type="select"
              >
                <option value="" key="0" />
                {enterprises
