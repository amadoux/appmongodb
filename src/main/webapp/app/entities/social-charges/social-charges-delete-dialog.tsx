...
export const SocialChargesDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="appmongodbApp.socialCharges.delete.question">
        <Translate contentKey="appmongodbApp.socialCharges.delete.question" interpolate={{ id: socialChargesEntity.id }}>
