  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appmongodbApp.enterprise.home.createOrEditLabel" data-cy="EnterpriseCreateUpdateHeading">
            <Translate contentKey="appmongodbApp.enterprise.home.createOrEditLabel">Create or edit a Enterprise</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appmongodbApp.enterprise.companyName')}
              ...
              <ValidatedField
                label={translate('appmongodbApp.enterprise.businessRegisterNumber')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.enterprise.uniqueIdentificationNumber')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.enterprise.businessDomicile')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.enterprise.email')}
                id="enterprise-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.enterprise.businessPhone')}
              ...
              />
              <ValidatedField
                label={translate('appmongodbApp.enterprise.country')}
              ...
              <ValidatedField
                label={translate('appmongodbApp.enterprise.city')}
                id="enterprise-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedBlobField
                label={translate('appmongodbApp.enterprise.businessLogo')}
              ...
              />
              <ValidatedBlobField
                label={translate('appmongodbApp.enterprise.mapLocator')}
